...
namespace BtpTweak {
    ...
    public static class ModConfig {
        public static ConfigEntry<KeyboardShortcut> ReloadKey { get; private set; }
        public static ConfigOptions.ConfigurableValue<bool> 关闭所有特效 { get; private set; }
        public static ConfigOptions.ConfigurableValue<bool> 开启特效生成日志 { get; private set; }
        public static ConfigOptions.ConfigurableValue<bool> 开启战斗日志 { get; private set; }
        public static ConfigOptions.ConfigurableValue<bool> 开启特拉法梅 { get; private set; }
        ...
        public static ConfigOptions.ConfigurableValue<float> 牺牲基础掉率 { get; private set; }
        public static ConfigOptions.ConfigurableValue<string> 特效_间隔 { get; private set; }
        ...
        internal static void InitConfig(ConfigFile config) {
            ...
            每关难度增加量 = ConfigOptions.ConfigurableValue.CreateFloat(Main.PluginGUID, Main.PluginName, config, "难度", "每完成一关增加的难度（%）", 20f, 0, 100000f, "基础为100%，计算公式：基础难度 + 当前关卡数 x ~%");
