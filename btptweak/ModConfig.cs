    ...
    public static class ModConfig {
        ...
        internal static void InitConfig(ConfigFile config) {
            ...
            启用阶梯触发链 = AddCheckBoxOption(config,
                                ...
                                "启用阶梯触发链",
                                false,
                                "开启后，某些物品的触发方向将受到限制，未列出的物品不受影响。目前受影响的物品：完美巨兽 <= 黏弹 <= Atg-MK1导弹 = 等离子虾 = 尤克里里 = 聚合鲁特琴 = 冰火双环 <= 感应肉钩 <= 雷火双钻。（'<'左边的不能触发右边的，'='左右的可以互相触发）");
