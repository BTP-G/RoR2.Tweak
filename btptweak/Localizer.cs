...
namespace BtpTweak {
    ...
    internal static class Localizer {
        ...
        private static void 基础汉化() {
            ...
            AddOverlay("ITEM_ICERING_DESC", $"充能完毕后，<style=cIsDamage>不低于{RingsTweak.RingDamageRequired.ToBaseAndStkPct("（取双环中层数高的每层+_）")}伤害的攻击</style>击中敌人时会产生一道{"符文冰霜爆炸".ToIce()}轰击敌人，{"减速".ToIce()}周围敌人使其降低<style=cIsUtility>80%</style>的移动速度{RingsTweak.IceRingSlow80BuffDuration.ToUtil("_秒")}，合计造成{RingsTweak.IceRingDamageCoefficient.ToBaseAndStkPct().ToDmg()}的总伤害。充能时间<style=cIsUtility>10秒</style><style=cStack>（每双手环减少10%）</style>。<color=#FFFF00>工匠特殊效果：基础充能时间降低至1秒，并无视伤害要求。</color>", "zh-CN");
